<script lang="ts">
	...
	import { getMuniFacetedChartData, type ValueType } from '$lib/data';
	...
	function createAllCharts() {
		...
		const taxableData = getMuniFacetedChartData(data, muniCode, 'taxable');
		const exemptData = getMuniFacetedChartData(data, muniCode, 'exempt');
		const purtaData = getMuniFacetedChartData(data, muniCode, 'purta');
